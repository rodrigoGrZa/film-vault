...
const insertInitialData = async (db) => {
  const images = [
    ...
    {
      title: "Tren en movimiento",
      assetPath: require("../assets/000025.png"),
      location: "Avenida del ejercito 15, 15009",
      aperture: 2.0,
      iso: 400,
      time: "1/80",
      film_id: 49,
    ...
    {
      title: "Golf 4",
      assetPath: require("../assets/000020.png"),
      location: "Avenida de monelos 91, 15009",
      aperture: 2.0,
      iso: 200,
      time: "1/80",
      film_id: 49,
    ...
    {
      title: "Edificio ayuntamiento",
      assetPath: require("../assets/000004.png"),
      location: "Plaza de abastos 122, 15009",
      aperture: 1.8,
      iso: 100,
      time: "1/50",
      film_id: 49,
